<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:105:"D:\phpStudy\PHPTutorial\WWW\thinkcmf\public/themes/admin_simpleboot3/admin\theme\file_widget_setting.html";i:1551705626;s:95:"D:\phpStudy\PHPTutorial\WWW\thinkcmf\public\themes\admin_simpleboot3\admin\theme\functions.html";i:1551705626;s:87:"D:\phpStudy\PHPTutorial\WWW\thinkcmf\public\themes\admin_simpleboot3\public\header.html";i:1551705626;s:93:"D:\phpStudy\PHPTutorial\WWW\thinkcmf\public\themes\admin_simpleboot3\admin\theme\scripts.html";i:1551705626;}*/ ?>
<?php 
    ...
    <div class="wrap">
        ...
        <form method="post" class="js-ajax-form  margin-top-20" action="<?php echo url('theme/settingPost'); ?>">
            ...
            <?php if(!(empty($has_widget) || (($has_widget instanceof \think\Collection || $has_widget instanceof \think\Paginator ) && $has_widget->isEmpty()))): if(is_array($files) || $files instanceof \think\Collection || $files instanceof \think\Paginator): if( count($files)==0 ) : echo "" ;else: foreach($files as $key=>$file): if(!(empty($file['more']['widgets']) || (($file['more']['widgets'] instanceof \think\Collection || $file['more']['widgets'] instanceof \think\Paginator ) && $file['more']['widgets']->isEmpty()))): ?>
                        ...
                        <?php else: endif; endforeach; endif; else: echo "" ;endif; else: endif; ?>
