<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:99:"D:\phpStudy\PHPTutorial\WWW\thinkcmf\public/themes/admin_simpleboot3/portal\admin_article\edit.html";i:1551705626;s:87:"D:\phpStudy\PHPTutorial\WWW\thinkcmf\public\themes\admin_simpleboot3\public\header.html";i:1551705626;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form action="<?php echo url('AdminArticle/editPost'); ?>" method="post" class="form-horizontal js-ajax-form margin-top-20">
        <div class="row">
            <div class="col-md-9">
                ...
                <?php 
    \think\Hook::listen('portal_admin_article_edit_view_main',$temp5c9f3b25ecc9b,null,false);
 ?>
            </div>
            <div class="col-md-3">
                <table class="table table-bordered">
                ...
                <?php 
    \think\Hook::listen('portal_admin_article_edit_view_right_sidebar',$temp5c9f3b25ecc9b,null,false);
 ?>
            </div>
        </div>
