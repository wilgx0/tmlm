...
<style>
    ...
    <script src="/static/yili/js/moment-with-locales.min.js"></script>
    <script>
        moment().locale('zh-cn');
...
<div class="Z_zjyltit">
    ...
    <div class="Z_zxggtit"><span><?php echo $category['name']; ?></span></div>
    <!--二级导航结束-->
    <!-- 内容 开始-->
...
<script>
    ...
    $(function(){
        ...
        var navId = "<?php echo request()->get('categoryId') ?>";
