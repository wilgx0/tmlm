<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:91:"D:\phpStudy\PHPTutorial\WWW\thinkcmf\public/themes/admin_simpleboot3/admin\route\index.html";i:1551705626;s:87:"D:\phpStudy\PHPTutorial\WWW\thinkcmf\public\themes\admin_simpleboot3\public\header.html";i:1551705626;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <tr>
                    ...
                    <td>
                        <?php if($vo['type'] == '2'): ?>
                            ...
                            <?php if($vo['status'] == '1'): ?>
                                <a class="btn btn-xs btn-warning js-ajax-dialog-btn" href="<?php echo url('route/ban',array('id'=>$vo['id'])); ?>"
                                   data-msg="确定禁用吗？">禁用</a>
                                <?php else: ?>
                                <a class="btn btn-xs btn-warning js-ajax-dialog-btn" href="<?php echo url('route/open',array('id'=>$vo['id'])); ?>"
                                   data-msg="确定启用吗？">启用</a>
                            <?php endif; ?>
                            <a class="btn btn-xs btn-danger js-ajax-delete" href="<?php echo url('route/delete',array('id'=>$vo['id'])); ?>">删除</a>
                        <?php endif; ?>
                    </td>
                </tr>
