<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:101:"D:\phpStudy\PHPTutorial\WWW\thinkcmf\public/themes/admin_simpleboot3/admin\theme\file_array_data.html";i:1551705626;s:87:"D:\phpStudy\PHPTutorial\WWW\thinkcmf\public\themes\admin_simpleboot3\public\header.html";i:1551705626;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form method="post" class="js-ajax-form margin-top-20">
        <table class="table table-hover table-bordered table-list">
            ...
            <?php if(is_array($array_items) || $array_items instanceof \think\Collection || $array_items instanceof \think\Paginator): if( count($array_items)==0 ) : echo "" ;else: foreach($array_items as $itemKey=>$item): ?>
                <tr>
                    <?php if(is_array($array_item) || $array_item instanceof \think\Collection || $array_item instanceof \think\Paginator): if( count($array_item)==0 ) : echo "" ;else: foreach($array_item as $key=>$vo): ?>
                        <td><?php echo (isset($item[$key]) && ($item[$key] !== '')?$item[$key]:''); ?></td>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    <td>
